...
#include <iostream>
using namespace vex;
float left_drive_power, right_drive_power, intake_power, sweeper_power;
bool left_drive_controller_on, right_drive_controller_on, intake_controller_on, sweeper_controller_on;
bool left_drive_vel_control, right_drive_vel_control, intake_vel_control;
int left_drive_stopping = 0, right_drive_stopping = 0, intake_stopping = 0, sweeper_stopping = 0;
